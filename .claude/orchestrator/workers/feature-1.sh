...
claude --model claude-sonnet-4-5 --allowedTools "Bash,Read,Write,Edit,Glob,Grep,Task,TodoWrite" --permission-mode default --mcp-config '{"mcpServers":{}}' -p "$PROMPT" 2>&1 | tee '/home/agent/modelscan/.claude/orchestrator/workers/feature-1.log'
